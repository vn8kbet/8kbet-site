! function() {
    ...
    if ("querySelector" in document && "addEventListener" in window) {
        ...
        var o = function(t) {
            ...
            u = function(e) {
                if (e && r.classList.contains("dropdown-hover")) {
            ...
            for (p = 0; p < e.length; p++) {
                ...
                if ((t = l && !t.closest("nav").classList.contains("mobile-menu-control-wrapper") ? l.querySelector(".menu-toggle") : t) && null === t.offsetParent) {
                    if (e[p].classList.contains("toggled")) {
                        var n, s, o, r = !1;
                        if ((r = e[p].classList.contains("mobile-menu-control-wrapper") ? !0 : r) || (s = (n = e[p].getElementsByTagName("ul")[0]) ? n.getElementsByTagName("li") : [], o = n ? n.getElementsByTagName("ul") : []), document.activeElement.blur(), e[p].classList.remove("toggled"), c.classList.remove("mobile-menu-open"), t.setAttribute("aria-expanded", "false"), !r) {
